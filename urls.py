...
urlpatterns = patterns('',
   ...
   url(r'^site/(\d+)/close', 'sitemngr.views.close_site', name='sm_close_site'),
   url(r'^site/(\d+)', 'sitemngr.views.edit_site', name='sm_site'),
   url(r'^site/add', 'sitemngr.views.add_site', name='sm_add_site'),
   url(r'^wormhole/(\d+)/close', 'sitemngr.views.close_wormhole', name='sm_close_wormhole'),
   url(r'^wormhole/(\d+)', 'sitemngr.views.edit_wormhole', name='sm_wormhole'),
   url(r'^wormhole/add', 'sitemngr.views.add_wormhole', name='sm_add_wormhole'),
   url(r'^recentscanedits', 'sitemngr.views.recent_scan_edits', name='sm_recent_scan_edits'),
   url(r'^graph', 'sitemngr.views.graph', name='sm_graph'),
   ...
   url(r'^createaccount', 'sitemngr.views.create_account', name='sm_create_account'),
   url(r'^overlay', 'sitemngr.views.overlay', name='sm_overlay'),
   url(r'^gettradehubjumps/(.+)', 'sitemngr.views.get_tradehub_jumps', name='sm_get_tradehub_jumps'),
   url(r'^getsearchresults/(.+)', 'sitemngr.views.get_search_results', name='sm_get_search_results'),
   ...
   url(r'^systemkills/(.+)', 'sitemngr.views.system_kills', name='sm_system_kills'),
)
