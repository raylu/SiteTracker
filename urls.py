...
urlpatterns = patterns('',
   ...
   url(r'^site/(\d+)/view', 'sitemngr.views.view_site', name='sm_view_site'),
   url(r'^site/(\d+)/edit', 'sitemngr.views.edit_site', name='sm_edit_site'),
   url(r'^site/add', 'sitemngr.views.add_site', name='sm_add_site'),
   url(r'^wormhole/(\d+)/view', 'sitemngr.views.view_wormhole', name='sm_view_wormhole'),
   url(r'^wormhole/(\d+)/edit', 'sitemngr.views.edit_wormhole', name='sm_edit_wormhole'),
