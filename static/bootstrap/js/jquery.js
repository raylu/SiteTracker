 ...
 * @param {Boolean}
 *            test The result of a test. If true, null will be set as the
 *            handler in leiu of the specified handler
 */
...
function boolHandler( elem, name ) {
	// XML does not need to be checked as this will not be assigned for XML
	// documents
